...
현재 `01_data_preprocessing`, `02_benchmark_selection`, `03_lag_analysis`, `04_fair_price_model`은 원본 Colab 셀을 분리해 실행 가능한 형태로 정리했습니다. 나머지 단계는 다음 작업에서 순차적으로 채울 예정입니다.
